...
public class DealerHand extends Hand {
	...
	@Override
	/**
	 * https://www.blackjackinfo.com/blackjack-rules/rule-variations/ Dealer Hits
	 * Soft 17 Generally, the dealer in blackjack must hit if he has a total of 16
	 * or less, and stand if he has 17 or more.
	 * 
	 * But at some games there is an exception when the dealer has a hand of "soft"
	 * 17.
	 * 
	 * If you look at the table, you will see one of two phrases on the felt: -
	 * Dealer Stands on All 17s: This is the simple version. The dealer will stand
	 * with any total of 17 or more, whether that total is soft or not. (This rule
	 * is abbreviated S17. The S is for Stand, not Soft!)
	 * 
	 * - Dealer Hits Soft 17: In casinos with this rule, the dealer will stand with
	 * any hard 17, but draw another card if he has a soft 17, such as (Ace, 2, 4).
	 * (This rule is abbreviated H17.)
	 * 
	 * Seventeen is a weak hand, so if the dealer is allowed to try to improve the
	 * soft 17 hands, it makes the game tougher. When a dealer is allowed to hit
	 * soft 17, it adds about 0.2% to the house advantage. Years ago, the only "Hit
	 * Soft 17" games in the US were in and around Reno, Nevada. Almost all other
	 * areas used the better rule of standing on all 17s. * Over the years, more and
	 * more casinos have switched to hitting soft 17, and there are now far more H17
	 * games than S17 games.
	 * 
	 * You can still find some games where the dealer stands on all 17s, even in
	 * casinos where some of the tables use the H17 rule. Look around!
	 */
	public void play() {
	...
	/**
	 * @param gameStatus
	 * @return positive number if user won, negative if lost money. 0 if pushed.
	 *         Returns the sum of all the games in the hand, including splits
	 */
