...
public class SimpleCards {
	...
	enum Face {
		ONE("1"), TWO("2"), THREE("3"), FOUR("4"), FIVE("5"), SIX("6"), SEVEN("7"), EIGHT("8"), NINE("9"), JACK("J"),
		QUEEN("Q"), KING("K");
		...
		private static Face[] items = new Face[] { ONE, TWO, THREE, FOUR, FIVE, SIX, SEVEN, EIGHT, NINE, JACK, QUEEN,
				KING };
	}
	...
	enum Suit {
		...
		public static Suit[] items = new Suit[] { CLUBS, DIAMONDS, HEARTS, SPADES };
	}
	...
	public class GamePane extends JPanel {
		...
		public GamePane(final List<Hand> players) {
